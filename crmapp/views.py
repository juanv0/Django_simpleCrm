...
from .models import Account, Activity, ActivityStatus, Contact, ContactStatus, ContactSource
from .serializers import AccountSerializer, ActivitySerializer, ActivityStatusSerializer, ContactSerializer, ContactStatusSerializer, ContactSourceSerializer
